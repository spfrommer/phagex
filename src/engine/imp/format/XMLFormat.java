...
public class XMLFormat extends Format<String, EntityDef, EntityDef> {	
	...
	public void addMetaEncoder(MetaEncoder<EntityDef, String> encoder) { m_metaEncoders.add(encoder); }
	...
	public void removeMetaEncoder(MetaEncoder<EntityDef, String> encoder) { m_metaEncoders.remove(encoder); }
	...
	public static class XMLScriptDataDecoder implements Decoder<Element, Component> {
		...
		public Component decode(Element value) {
			...
			for (Element var : value.children()) {
				...
				} else throw new RuntimeException("Cannot decode: " + value);
			}
			return data;
		}
	}
	public static class XMLScriptDataEncoder implements Encoder<Component, String> {
		...
		@Override
		public String encode(Component object) {
			if (!isEncodable(object)) throw new IllegalArgumentException("Cannot decode: " + object);
		...
		public String encodeData(Object val) {
			...
			} else throw new RuntimeException("Cannot encode: " + val);			
		}
	}
